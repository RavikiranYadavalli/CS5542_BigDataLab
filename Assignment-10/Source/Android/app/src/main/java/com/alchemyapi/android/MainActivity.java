...
public class MainActivity extends Activity {
	 ...
	 */
	public String AlchemyAPI_Key = "74f4fe55c2cde72eea87616a344f1b8c37793d76";
	
    /** Called when the activity is first created. aabdba1ee132cfffe6a3a550fdb3fffe2c3faee0*/
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main);
        
        urlText = (EditText) findViewById(R.id.entry);
